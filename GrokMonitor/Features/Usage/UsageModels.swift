...
enum ProductColor: String, Codable, CaseIterable, Sendable {
    ...
    var sRGB: (red: Double, green: Double, blue: Double, alpha: Double) {
        switch self {
        case .build: return (0.22, 0.48, 0.92, 1) // dark blue — Grok Build
        case .api: return (0.30, 0.58, 0.98, 1) // medium blue — API
        case .chat: return (0.55, 0.82, 1.0, 1) // light blue — Chat
        case .imagine: return (0.85, 0.45, 0.85, 1)
        case .voice: return (0.95, 0.65, 0.25, 1)
...
enum ProductCatalog {
    ...
    static let displayOrder = ["chat", "build", "api", "imagine", "voice"]
