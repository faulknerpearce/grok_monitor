...
Security fixes are applied on the latest `master` branch. Please upgrade to the newest commit when a fix is published.
...
- Credit in the advisory or release notes if you want it
